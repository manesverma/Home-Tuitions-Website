    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <div class="wrapper col2">
            <div id="featured_slide">
                <div><a href="#"><img src="images/demo/setting.jpg" height="300px;" width="960px;" alt="" /></a>
                ...
                <form action="profilesettingstudent.php" method="post">
                    <table cellpadding="1" cellspacing="1" border="0">
                        ...
                        <tr>
                            ...
                            ?>
                        <?php
                                $query = "select * from signup where uname = '$user_id1'";
                                            ...
                                            <fieldset>
                                                ...
                                                <table cellpadding="5" cellspacing="5" class="table_data">
													...
													<option value="12">12</option>
															...
															<select name="yy">
															<option value="<?php echo $row ['yy']; ?>" selected><?php echo $row ['yy']; ?></option>
                        ...
                        ?>
                                <tr>
                                    <td colspan="2" align="center"><input type="submit" name="btnupdate" id="btnupdate" class="button" value="Update"/></td>
                                </tr>
