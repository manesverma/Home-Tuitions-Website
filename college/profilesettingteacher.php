...
$query = "update teacher set  fname='$fname' ,lname='$lname' ,gender='$gender',dob='$dob',mob='$phone',email='$email',address='$address',city='$city',pin='$pin',state='$state',country='$country' where uname='$user_id'";
$r = mysql_query($query);
$num = (int) $r;
if ($num > 0) {
...
header("location:MyAccountTeacher1.php");
?>
