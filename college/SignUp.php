    ...
    <html>
        ...
        <div class="wrapper col2">
            <div id="featured_slide">
                <div><a href="#"><img src="images/demo/signup.png" height="300px;" width="960px;" alt="" /></a>
                            ...
                            <td>
                                <fieldset>
                                    ...
                                    <table cellpadding="5" cellspacing="5">
                                        ...
                                        //$r = mysql_query($query);
                                        $result = mysql_query("select * from signup order by (sid)desc limit 1");
                                        ...
                                        <tr>
                                            ...
                                            <td class="text"><span style="color: red;">*</span> Student&nbsp;Username:</td>
                                        ...
                                        <tr>
                                            <td class="text"><span style="color: red;"></span>&nbsp;Subject&nbsp;Name:</td>
                                            <td class="text">
                                                <select  id="maintainclass"name="maintainclass" style="width: 180px">
                                                    <option value="Select"> - - - - - Select- - - - - </option>
                                                    <option value="BCA">Physics</option>
                                                    <option value="MCA">Maths</option>
                                                    <option value="B.Tech">Chemistry</option>
