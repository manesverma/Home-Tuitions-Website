					...
					<table border="3" cellpadding="10px" cellspacing="10px" class="table_data">
							...
							<td>
								...
								<?php
									if(isset($_POST['monday'])) {
										$query = "update teacher_timetable set 10to11='$_POST[m10to11]', 11to12='$_POST[m11to12]', 12to1='$_POST[m12to1]', 1to2='$_POST[m1to2]', 2to3='$_POST[m2to3]', 3to4='$_POST[m3to4]', 4to5='$_POST[m4to5]', 5to6='$_POST[m5to6]', 6to7='$_POST[m6to7]', 7to8='$_POST[m7to8]' where day = 1 ";
										mysql_query($query);
							...
							<td>
								...
								<?php
									if(isset($_POST['tuesday'])) {
										$query = "update teacher_timetable set 10to11='$_POST[t10to11]', 11to12='$_POST[t11to12]', 12to1='$_POST[t12to1]', 1to2='$_POST[t1to2]', 2to3='$_POST[t2to3]', 3to4='$_POST[t3to4]', 4to5='$_POST[t4to5]', 5to6='$_POST[t5to6]', 6to7='$_POST[t6to7]', 7to8='$_POST[t7to8]' where day = 2 ";
										mysql_query($query);
						...
						<tr>
							...
							<td>
								...
								<?php
									if(isset($_POST['monday'])) {
										$query = "update teacher_timetable set 10to11='$_POST[w10to11]', 11to12='$_POST[w11to12]', 12to1='$_POST[w12to1]', 1to2='$_POST[w1to2]', 2to3='$_POST[w2to3]', 3to4='$_POST[w3to4]', 4to5='$_POST[w4to5]', 5to6='$_POST[w5to6]', 6to7='$_POST[w6to7]', 7to8='$_POST[w7to8]' where day = 3 ";
										mysql_query($query);
									}
								?>
							</td>
						...
						<tr>
							...
							<td>
								...
								<?php
									if(isset($_POST['monday'])) {
										$query = "update teacher_timetable set 10to11='$_POST[th10to11]', 11to12='$_POST[th11to12]', 12to1='$_POST[th12to1]', 1to2='$_POST[th1to2]', 2to3='$_POST[th2to3]', 3to4='$_POST[th3to4]', 4to5='$_POST[th4to5]', 5to6='$_POST[th5to6]', 6to7='$_POST[th6to7]', 7to8='$_POST[th7to8]' where day = 4 ";
										mysql_query($query);
									}
								?>
							</td>
						...
						<tr>
							...
							<td>
								...
								<?php
									if(isset($_POST['monday'])) {
										$query = "update teacher_timetable set 10to11='$_POST[f10to11]', 11to12='$_POST[f11to12]', 12to1='$_POST[f12to1]', 1to2='$_POST[f1to2]', 2to3='$_POST[f2to3]', 3to4='$_POST[f3to4]', 4to5='$_POST[f4to5]', 5to6='$_POST[f5to6]', 6to7='$_POST[f6to7]', 7to8='$_POST[f7to8]' where day = 5 ";
										mysql_query($query);
									}
								?>
							</td>
						...
						<tr>
							...
							<td>
								...
								<?php
									if(isset($_POST['monday'])) {
										$query = "update teacher_timetable set 10to11='$_POST[s10to11]', 11to12='$_POST[s11to12]', 12to1='$_POST[s12to1]', 1to2='$_POST[s1to2]', 2to3='$_POST[s2to3]', 3to4='$_POST[s3to4]', 4to5='$_POST[s4to5]', 5to6='$_POST[s5to6]', 6to7='$_POST[s6to7]', 7to8='$_POST[s7to8]' where day = 6 ";
										mysql_query($query);
									}
								?>
							</td>
